...
def test_etf_mapping():
    ...
    # 測試取得fund_id
    fund_id = scraper.get_fund_id('00984A')
    print(f"00984A -> {fund_id}")
    ...
    assert fund_id == 'E0001', "ETF 代碼對照錯誤"
    print("✅ ETF 代碼對照測試通過")
    return True
...
def test_get_holdings():
    """測試抓取持股明細"""
    print("\n" + "=" * 70)
    print("測試抓取 00984A 持股明細（Playwright DOM 提取）")
    print("=" * 70)
    ...
    print("\n注意：此方法會啟動瀏覽器並點擊「顯示更多」按鈕...")
    
    # 抓取持股
    holdings = scraper.get_etf_holdings('00984A', date_str)
